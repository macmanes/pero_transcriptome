...
\begin{adjustwidth}{-.35in}{-.05in}% adjust the L and R margins by 1 inch
...
Transcript\_96470 & XM\_006987129.1 & interferon-inducible GTPase 1-like & 2.77 \\
 \end{tabular}
\begin{quote}
\small{Table 4. The 10 transcripts with the highest values for Tajima's D, which is suggestive of positive selection.}
\end{quote}  
\end{adjustwidth}
...
Transcript\_33267 & XM\_006975561.1 & pumilio RNA-binding family member 1 (Pum1) & -2.75\\
 \end{tabular}
\begin{quote}
\small{Table 3. The 10 transcripts with the lowest values for Tajima's D, which is suggestive of purifying selection.}
\end{quote}  
\end{adjustwidth}
